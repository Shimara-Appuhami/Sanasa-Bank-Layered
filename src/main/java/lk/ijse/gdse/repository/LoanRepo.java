...
//    public static boolean save(LoanDTO loanDTO) throws SQLException {
//        Connection connection = null;
//        PreparedStatement pstm = null;
//        boolean isSaved = false;
//
//        System.out.println("Saving order : " + loanDTO);
...
//            loanStatement.setString(1, loanDTO.getLoanId());
//            loanStatement.setString(2, loanDTO.getCustomerId());
//            loanStatement.setString(3, loanDTO.getApplication());
//            loanStatement.setString(4, loanDTO.getLoanType());
//            loanStatement.setDouble(5, Double.parseDouble(loanDTO.getLoanAmount()));
//            loanStatement.setString(6, loanDTO.getLoanTerm());
//            loanStatement.setString(7, loanDTO.getCollateral());
//            loanStatement.setString(8, loanDTO.getPurpose());
//            loanStatement.setDouble(9, Double.parseDouble(String.valueOf(loanDTO.getPercentage())));
//            loanStatement.setString(10, loanDTO.getNic());
//            loanStatement.setString(11, loanDTO.getDate());
//
...
//
//
//    public static boolean update(LoanDTO loanDTO) throws SQLException {
//        Connection connection = null;
//        PreparedStatement pstm = null;
...
//            pstm.setString(1, loanDTO.getCustomerId());
//            pstm.setString(2, loanDTO.getApplication());
//            pstm.setDouble(3, Double.parseDouble(loanDTO.getLoanAmount()));
//            pstm.setString(4, loanDTO.getLoanType());
//            pstm.setString(5, loanDTO.getLoanTerm());
//            pstm.setString(6, loanDTO.getCollateral());
//            pstm.setString(7, loanDTO.getPurpose());
//            pstm.setDouble(8, loanDTO.getPercentage());
//            pstm.setString(9, loanDTO.getNic());
//            pstm.setString(10, loanDTO.getDate());
//            pstm.setString(11, loanDTO.getLoanId());
//
