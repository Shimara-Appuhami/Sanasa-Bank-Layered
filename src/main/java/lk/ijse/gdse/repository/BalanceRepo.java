...
//    public static boolean save(BalanceDTO balanceDTO) throws SQLException {
...
//            pstm.setString(1, balanceDTO.getBId());
//            pstm.setString(3, balanceDTO.getPrincipalBalance());
//            pstm.setString(4, balanceDTO.getInterestBalance());
//            pstm.setString(5, balanceDTO.getTotalBalance());
//            pstm.setString(6, balanceDTO.getLastUpdatedDate());
//            pstm.setString(2, balanceDTO.getLoanId());
//
...
//    public static boolean update(BalanceDTO balanceDTO) throws SQLException {
//        Connection connection = null;
//        PreparedStatement pstm = null;
...
//            pstm = connection.prepareStatement(sql);
//            pstm.setString(6, balanceDTO.getBId());
//            pstm.setString(2, balanceDTO.getPrincipalBalance());
//            pstm.setString(3, balanceDTO.getInterestBalance());
//            pstm.setString(4, balanceDTO.getTotalBalance());
//            pstm.setString(5, balanceDTO.getLastUpdatedDate());
//            pstm.setString(1, balanceDTO.getLoanId());
//
