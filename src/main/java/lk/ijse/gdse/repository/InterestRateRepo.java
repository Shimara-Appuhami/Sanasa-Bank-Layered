...
//    public static boolean save(InterestRateDTO interestRateDTO) throws SQLException {
...
//            pstm.setString(1, interestRateDTO.getRateId());
//            pstm.setString(2, interestRateDTO.getLoanType());
//            pstm.setString(3, interestRateDTO.getPercentage());
//
//
...
//
//
//    public static boolean update(InterestRateDTO interestRateDTO) throws SQLException {
//        Connection connection = null;
//        PreparedStatement pstm = null;
...
//            pstm = connection.prepareStatement(sql);
//            pstm.setString(3, interestRateDTO.getRateId());
//            pstm.setString(1, interestRateDTO.getLoanType());
//            pstm.setString(2, interestRateDTO.getPercentage());
//
//
...
//    }
//
//    public static InterestRateDTO searchById(String loanTYpe) throws SQLException {
//        String sql = "SELECT * FROM interest_rate WHERE loan_type = ?";
//        Connection connection = null;
//        PreparedStatement pstm = null;
//        ResultSet resultSet = null;
//        InterestRateDTO interestRateDTO = null;
//
//        try {
//            connection = DbConnection.getInstance().getConnection();
//            pstm = connection.prepareStatement(sql);
...
//                 interestRateDTO = new InterestRateDTO( rateId,loanTYpe, percentage);
//            }
//        } catch (SQLException e){
//            new Alert(Alert.AlertType.ERROR,e.getMessage()).show();
//        }
...
//        }
//    }*/
//    public static List<InterestRateDTO> getAll() throws SQLException {
